...
/** 41 позиция — только то, что в пронумерованных папках «Меню грузия» */
...
export const SITE = {
  ...
  url: SITE_URL,
  description:
    "Доставка шашлыка на мангале, люля-кебаба, грузинских салатов и сетов в Петергофе, Ломоносове, Стрельне и Петродворцовом районе. 41 блюдо — готовим на углях и привозим горячим.",
