/** Shared SVG icons — single source of truth, no more duplication */
...
export function VkIcon({ size = 18, className }: IconProps) {
  return (
...
export function OrderIcon({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} aria-hidden>
