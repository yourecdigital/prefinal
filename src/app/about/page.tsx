...
export const metadata: Metadata = {
  ...
  description:
    "«Вкусно как в Грузии» — доставка шашлыка на мангале, горячих закусок и грузинских блюд в Петергоф, Ломоносов, Стрельну и Петродворцовый район. 47 блюд, готовим на углях.",
