...
export const metadata: Metadata = {
  ...
  description:
    "«Вкусно как в Грузии» — доставка шашлыка на мангале, хачапури, горячих закусок и грузинских блюд в Петергоф, Ломоносов, Стрельну и Петродворцовый район. 53 блюда, готовим на углях.",
